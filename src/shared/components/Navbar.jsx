      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link 
              to="/signup" 
              className="bg-[#0066fe] text-white px-4 py-1.5 rounded-full text-sm font-medium shadow-sm hover:bg-blue-700 transition-all transform active:scale-95"
            >
              Sign Up
            </Link>
          </div>
        ...
        <div className="px-4 pt-3 pb-4 space-y-3">
          ...
          <div className="space-y-2 pt-2">
            ...
            <Link 
              ...
              className="block text-center bg-[#0066fe] text-white px-4 py-1.5 rounded-full text-base font-medium shadow-sm"
            >
              Sign Up
            </Link>
          </div>
