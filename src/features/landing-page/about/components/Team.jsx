function TeamSection(){
    const teamMembers = [
  {
    ...
    badge: 'FE',
    description: 'Responsible for building the user interface and ensuring a seamless experience using React and Tailwind CSS.',
  },
  {
    name: 'Furqan',
    role: 'Frontend Developer',
    badge: 'FE', 
    description: 'Crafting responsive and interactive components with React and Tailwind CSS for a modern user journey.',
  },
  {
    name: 'Talha',
  ...
  },
  {
    ...
    role: 'AI Engineer',
    badge: 'AI',
    description: 'Integrating advanced AI capabilities, including ML-driven email classification and intelligent automation.',
  },
];
    return(
        <>
