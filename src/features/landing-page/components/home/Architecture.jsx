    ...
    <section className="py-20 px-4 md:px-6 bg-white">
      <div className="max-w-300 mx-auto">
        <FadeUp className="text-center mb-14">
          <h2
            className="text-main-heading-2 md:text-main-heading-2-md font-bold text-heading mb-3"
            style={{ fontFamily: "'Newsreader', serif" }}
          >
            Platform Architecture
          </h2>
          <p className="text-[16px] text-[#434655]">
            How our intelligent engine powers institutional communication
          </p>
        </FadeUp>
        ...
        <FadeUp
          delay={0.1}
          className="flex items-start justify-center gap-0 flex-wrap md:flex-nowrap mb-14"
        >
            ...
            return (
              <div key={step.id} className="flex items-center">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-[12px] text-[#434655] font-medium text-center whitespace-nowrap">
                    {step.label}
                  </span>
                </div>
                {i < ARCH_STEPS.length - 1 && (
                  <div className="flex items-center mb-5 mx-3">
                    ...
                    <ArrowRight
                      className="w-3.5 h-3.5 text-[#c3d9ff] -ml-1"
                      strokeWidth={2}
                    />
                  </div>
                )}
        ...
        <FadeUp delay={0.2}>
          <div className="bg-secondary-background rounded-2xl p-6 md:p-8 grid md:grid-cols-2 gap-6 items-center min-w-0">
            <div className="min-w-0">
              ...
              <div className="flex flex-wrap gap-2">
                {TECH_TAGS.map((tag) => (
                  <span
                    key={tag}
                    className="text-[13px] border border-white/20 text-white/80 px-3 py-1 rounded-full font-medium"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className="bg-[#0f1e2e] rounded-xl p-5 border border-white/5 min-w-0 w-full max-w-full">
              ...
              <pre
                className="text-[12px] leading-relaxed overflow-x-auto max-w-full"
