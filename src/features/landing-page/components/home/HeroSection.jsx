              ...
              <div className="bg-[#0f1e2e] p-4 min-h-85 md:min-h-100 flex gap-3">
                ...
                <div className="w-36 shrink-0 bg-[#162030] rounded-xl p-3 space-y-2 hidden md:block">
                  {[
                    ...
                    <div
                      key={item}
                      className={`h-7 rounded-lg flex items-center px-2 text-[11px] font-medium
                ...
                <div className="flex-1 space-y-3">
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ["Notifications Sent", "3,820", "+12%"],
                      ["Delivery Rate", "98.4%", "+2%"],
                      ["Active Workflows", "14", "+3"],
                    ].map(([l, v, t]) => (
                  ...
                  <div className="bg-[#162030] rounded-xl p-3">
                    <p className="text-[11px] text-white/40 mb-3">
                      Communication Volume — 2025
                    </p>
                    <div className="flex items-end gap-1.5 h-24">
                      {[30, 55, 40, 70, 85, 60, 90, 75, 95, 65, 80, 100].map(
                        (h, i) => (
                          <div
                            key={i}
                            className="flex-1 rounded-sm bg-[#004ac6]/60 hover:bg-[#004ac6] transition-colors"
                            style={{ height: `${h}%` }}
                          />
                        ),
                      )}
